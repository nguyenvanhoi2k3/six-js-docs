...
>
  ...
  <div class="content" style="background: #fff">
    ...
    <sx-dialog-trigger name="dialog1">Đóng</sx-dialog-trigger>
      ...
      <p class="note">
        {" "}
        <span class="c-accent">sx-close-cursor</span> replace cursor mặc định khi di chuột vào vùng overlay (cần <span class="c-accent">close-on-outside-click="true"</span> để hiện).
      </p>
      <p class="note">
        {" "}
      ...
      {attrsTable([
        ...
        ["overlay-style", "chuỗi CSS inline cho lớp overlay", "background-color: rgba(0,0,0,0.5);"],
  ...
  demos: [
      ...
      renderDemo: () => (
        <>
          <div class="content-pane__panel">
            <sx-dialog-trigger class="btn btn--primary" name="basic-demo">
              Mở dialog
            </sx-dialog-trigger>
          </div>
          ...
          <sx-dialog name="basic-demo" effect="zoom" position="center">
            <div class="card" style="width: min(420px, 80vw)">
              ...
              <sx-dialog-trigger class="btn btn--ghost" name="basic-demo">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
    ...
    },
    {
      renderDemo: () => (
        <>
          <div class="content-pane__panel">
            <sx-dialog-trigger class="btn btn--primary" name="fx-fade">
              fade
            </sx-dialog-trigger>
            <sx-dialog-trigger class="btn btn--primary" name="fx-zoom-in">
              zoom-in
            </sx-dialog-trigger>
            <sx-dialog-trigger class="btn btn--primary" name="fx-slide-up">
              slide-up
            </sx-dialog-trigger>
            <sx-dialog-trigger class="btn btn--primary" name="fx-flip-x">
              flip-x
            </sx-dialog-trigger>
          </div>

          <sx-dialog name="fx-fade" effect="fade" position="center">
            <div class="card" style="width: min(360px, 80vw)">
              <h2>effect="fade"</h2>
              <sx-dialog-trigger class="btn btn--ghost" name="fx-fade">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
          <sx-dialog name="fx-zoom-in" effect="zoom-in" position="center">
            <div class="card" style="width: min(360px, 80vw)">
              <h2>effect="zoom-in"</h2>
              <sx-dialog-trigger class="btn btn--ghost" name="fx-zoom-in">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
          <sx-dialog name="fx-slide-up" effect="slide-up">
            <div class="card" style="width: min(420px, 90vw)">
              <h2>effect="slide-up"</h2>
              <sx-dialog-trigger class="btn btn--ghost" name="fx-slide-up">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
          <sx-dialog name="fx-flip-x" effect="flip-x" position="center">
            <div class="card" style="width: min(360px, 80vw)">
              <h2>effect="flip-x"</h2>
              <sx-dialog-trigger class="btn btn--ghost" name="fx-flip-x">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
    ...
    },
    {
        ...
        <>
          <div class="content-pane__panel">
            {["center", "top", "bottom", "left", "right", "top-left", "top-right", "bottom-left", "bottom-right"].map((p) => (
              <button class="btn btn--ghost btn--sm" data-position={p}>
                {p}
              </button>
            ))}
          </div>
          ...
          <sx-dialog name="position-demo" effect="zoom" position="center">
            <div class="card" style="width: min(320px, 80vw)">
              ...
              <sx-dialog-trigger class="btn btn--ghost" name="position-demo">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
      ...
      initDemo: (root) => {
        ...
        root.querySelectorAll<HTMLButtonElement>("[data-position]").forEach((btn) => {
    ...
    },
    {
      renderDemo: () => (
        <div class="flex gap-20">
          <div class="content-pane__panel">
            <sx-dialog-trigger class="btn btn--primary" name="pull-demo">
              Pull down
            </sx-dialog-trigger>
          </div>
          ...
          <div class="content-pane__panel">
            <sx-dialog-trigger class="btn btn--primary" name="pull-demo2">
              Pull up
            </sx-dialog-trigger>
          </div>
          ...
          <div class="content-pane__panel">
            <sx-dialog-trigger class="btn btn--primary" name="pull-demo3">
              Pull right
            </sx-dialog-trigger>
          </div>
    ...
    },
    {
      renderDemo: () => (
        <>
          <div class="content-pane__panel">
            <sx-dialog-trigger class="btn btn--primary" name="dialog-demo-cursor">
              Cursor
            </sx-dialog-trigger>
          </div>
          ...
          <sx-dialog name="dialog-demo-cursor" effect="zoom" position="center">
            ...
            <div class="card" style="width: min(420px, 80vw)">
              <h2>Xin chào</h2>
              <p>Click ra ngoài, hoặc nhấn Esc để đóng.</p>
              <sx-dialog-trigger class="btn btn--ghost" name="dialog-demo-cursor">
                Đóng
              </sx-dialog-trigger>
            </div>
          </sx-dialog>
          ...
          <sx-dialog name="nested-dialog" effect="zoom" position="center">
            <div class="card" style="width: min(420px, 80vw)">
              ...
              <sx-dialog name="nested-dialog-2">
                <div class="card" style="width: min(320px, 80vw)">
                  <div>Bạn chắc chắn muốn đóng modal chứ?</div>
                  <sx-dialog-trigger class="btn btn--ghost" name="nested-dialog-2">
                    No
                  </sx-dialog-trigger>
                  <sx-dialog-trigger class="btn btn--primary" name="nested-dialog">
